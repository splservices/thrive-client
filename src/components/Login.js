                                ...
                                <div className="authInnerWrapper">
                                    <div className="authBox">
                                        ...
                                        <form onSubmit={this.onSubmit}>
                                            ...
                                            <Grid container className='rememberme_txt'>
                                                ...
                                                <Grid item xs={6}>
                                                    <Typography variant="body2" style={{marginTop:10, textAlign:'right'}} gutterBottom>
                                            ...
                                            <Button type="submit" disabled={this.props.auth.isLoading} variant="contained" color="primary" fullWidth={true} size='large' className={classes.button}>
                                                LOGIN {this.props.auth.isLoading && <CircularProgress size={24} className={classes.progress} style={{marginLeft:10}} color="secondary" />}
